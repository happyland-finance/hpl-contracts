...
module.exports = async (hre) => {
  ...
  const happyLand = await upgrades.deployProxy(HappyLand, [hplAddress, hpwAddress, landAddress, houseAddress, constants.getOperator(chainId)], { unsafeAllow: ['delegatecall'], kind: 'uups', gasLimit: 1000000 })
